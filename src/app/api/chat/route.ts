...
export async function POST(req: NextRequest) {
  const { messages, item, deal, wsStrategy } = await req.json();
  ...
  const system = `You are an expert PMI (Post-Merger Integration) advisor embedded in IntegrationOS, helping private equity-backed companies execute integrations.
